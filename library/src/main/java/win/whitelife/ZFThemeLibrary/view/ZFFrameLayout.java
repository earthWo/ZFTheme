...
public class ZFFrameLayout extends FrameLayout implements BackgroundInterface {

    private String mBackground;

    private ZFThemeObserver themeObserver;

    public ZFFrameLayout(Context context) {
        this(context,null);
    }

    public ZFFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ZFFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
